        ...
        <div class="container">
            ...
            <div class="account">
                <div class="account-left">
                    <?php $pageSelected = 'trash'; require_once 'includes/account-sidebar.php'; ?>
                </div>
                    ...
                    <div class="messages-inner slate">
                        ...
                        <div class="messages-table">
                            <table>
                                ...
                                <tbody>
                                <?php
                                if($message->getTrashMessages()->count()):
                                    foreach($message->getTrashMessages()->results() as $m):
                                    ?>
                        ...
                        <?php else:
                            ...
                            <div class="read-message">
                                ...
                                <div class="message-footer clearfix">
                                    <div class="float-left">
                                        <a href="/messages/trash" class="button button-boring button-tiny"><span class="ion-chevron-left">&nbsp;</span> Back to Trash</a>
                                    </div>
                                    <div class="float-right">
                                        <a href="/messages/trash?r=<?php echo $read ?>" class="button button-success button-tiny"><span class="ion-archive">&nbsp;</span> Restore</a>
                                    </div>
                                </div>
                            </div>
                            <?php
