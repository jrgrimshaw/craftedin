        ...
        <div class="container">
            ...
            <div class="account">
                <div class="account-left">
                    <?php $pageSelected = 'pictures'; require_once 'includes/account-sidebar.php'; ?>
                </div>
                ...
                <div class="account-right">
                    <div class="account-inner slate">
                        ...
                        <div class="account-header">
                            ...
                            <img src="<?php echo USER_HEADER_DIR . $user->data()->header; ?>" alt="<?php echo escape($user->data()->name); ?>">
